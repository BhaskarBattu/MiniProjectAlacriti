...
var routes = [
    ...
    { path: 'Signin', component: signin_cmponent_1.SigninCmponent },
    { path: 'Login', component: registration_component_1.RegistrationComponent },
    { path: 'dashboard/MovieDescription/:id', component: moviedescription_component_1.MoviedescriptionComponent }
];
